...
## Warning
Although there is a basic blacklist to block certain content, this widget may attempt to fetch lyrics from an external API regardless of the type of media playing (such as videos). Do not use this widget if you have privacy concerns about this.
